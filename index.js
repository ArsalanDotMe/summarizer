...
var Vector = linearAlgebra.Vector; var Matrix = linearAlgebra.Matrix
...
var paraSentenceIndex = []; var pindex = 0; var allsentences = []
...
fs.readFile(program.filename, function (err, data) {
  var allsentences = []; var sentenceScores = []; var selectedSentences = []; var $ = cheerio.load(data); var title = $('h1').text()
